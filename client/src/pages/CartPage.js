...
const CartPage = () => {
  ...
  const getToken = async () => {
    try {
      ...
      console.log("Client token retrieved:", data?.clientToken); // Debugging log
  ...
  const handlePayment = async () => {
    try {
      ...
      console.log("Nonce received:", nonce); // Debugging log
              ...
              {!clientToken || !cart?.length ? (
                ...
                <>
                  <DropIn
                    ...
                    onInstance={(instance) => {
                      console.log("DropIn instance set"); // Debugging log
